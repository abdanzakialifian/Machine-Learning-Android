        ...
        textRecognizer.process(inputImage)
            .addOnSuccessListener { visionText ->
                ...
                if (detectedText.isNotBlank()) {
                    showLoading(false)
                    Intent(this, MLKitResultActivity::class.java).apply {
                        putExtra(MLKitResultActivity.EXTRA_IMAGE_URI, uri.toString())
                        putExtra(MLKitResultActivity.EXTRA_RESULT, detectedText)
                        startActivity(this)
                    }
                } else {
                    showLoading(false)
